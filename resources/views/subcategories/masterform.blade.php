...
<head>
    ...
    <!-- CSS Files -->
    <link href="{{URL::asset("formassets/css/bootstrap.min.css")}}" rel="stylesheet" />
    <link href="{{URL::asset("formassets/css/material-bootstrap-wizard.css")}}" rel="stylesheet" />

    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="{{URL::asset("formassets/css/demo.js")}}" rel="stylesheet" />
</head>

<body>
<div class="image-container set-full-height" style="background-image: url('{{URL::asset("loginassets/img/uol.jpg")}}')">
    <!--   Creative Tim Branding   -->
{{--  <a href="http://creative-tim.com">
      <div class="logo-container">
          <div class="logo">
              <img src="{{URL::asset("formassets/img/new_logo.png")}}">
          </div>
          <div class="brand">
              Creative Tim
          </div>
...
<!--   Core JS Files   -->
<script src="{{URL::asset("formassets/js/jquery-2.2.4.min.js")}}" type="text/javascript"></script>
<script src="{{URL::asset("formassets/js/bootstrap.min.js")}}" type="text/javascript"></script>
<script src="{{URL::asset("formassets/js/jquery.bootstrap.js")}}" type="text/javascript"></script>

<!--  Plugin for the Wizard -->
<script src="{{URL::asset("formassets/js/material-bootstrap-wizard.js")}}"></script>

<!--  More information about jquery.validate here: http://jqueryvalidation.org/	 -->
<script src="{{URL::asset("formassets/js/jquery.validate.min.js")}}"></script>
</html>
