    ...
    <div class="container">
        <div class="navbar-translate">
            ...
            <a class="navbar-brand" href="http://demos.creative-tim.com/now-ui-kit/index.html" rel="tooltip"
               title="NewsFeed of Unviersity of Lahore" data-placement="bottom" target="_blank">
                UOL Live
            </a>
        </div>
        <div class="collapse navbar-collapse justify-content-end" id="navigation"
             data-nav-image="{{URL::asset("userassets/img/blurred-image-1.jgp")}}">
            <ul class="navbar-nav">
                <li class="nav-item">
...
<div class="wrapper">
    <div class="page-header clear-filter" filter-color="orange">
        <div class="page-header-image" data-parallax="true"
             style="background-image: url({{ URL::asset('loginassets/img/uol.jpg')}});">
        </div>
        <div class="container">
           <div class="content-center brand">
                <img class="n-logo" src="{{URL::asset("userassets/img/now-logo.png")}}" alt="">
                <h1 class="h1-seo">UOL Live</h1>
                <h3>News related University Of Lahore</h3>
            </div>
           {{--<h6 class="category category-absolute">Designed by
                <a href="http://invisionapp.com/" target="_blank">
                    <img src="{{URL::asset("userassets/img/invision-white-slim.png")}}" class="invision-logo"/>
                </a>. Coded by
               --}}{{-- <a href="https://www.creative-tim.com" target="_blank">
                    <img src="{{URL::asset("userassets/img/creative-tim-white-slim2.png")}}"
    ...
    <div class="main">
                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       {{-- <div class="hero-images-container">
                            <img src="{{URL::asset("userassets/img/hero-image-1.png")}}" alt="">
                        </div>
                        <div class="hero-images-container-1">
                            <img src="{{URL::asset("userassets/img/hero-image-2.png")}}" alt="">
                        </div>
                        <div class="hero-images-container-2">
                            <img src="{{URL::asset("userassets/img/hero-image-3.png")}}" alt="">
                        </div>--}}
                    </div>
                </div>
            </div>
                ...
                <div id="buttons">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <button class="btn btn-primary btn-icon  btn-icon-mini btn-round" type="button">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group">
                                <input type="email" class="form-control" placeholder="With Border" value="">
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <div class="form-group has-success form-group-no-border">
        ...
        <div class="section section-navbars">
                        ...
                        <nav class="navbar navbar-toggleable-md bg-primary">
                            <div class="container">
                                ...
                                <div class="collapse navbar-collapse" id="example-navbar"
                                     data-nav-image="{{URL::asset("userassets/img/blurred-image-1.jpg")}}">
                                    <ul class="navbar-nav">
            ...
            <div id="navbar">
                <div class="navigation-example" style="background-image:url({{URL::asset("userassets/img/bg7.jpg")}});">
                    <!-- Navbar Primary  -->
                    <nav class="navbar navbar-toggleable-md bg-primary">
                        <div class="container">
                            <div class="navbar-translate">
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            <img src="{{URL::asset("userassets/img/avatar.jpg")}}" alt="Rounded Image" class="rounded">
                        </div>
                        <div class="col-sm-2 offset-sm-1">
                            <p class="category">Circle Image</p>
                            <img src="{{URL::asset("userassets/img/avatar.jpg")}}" alt="Circle Image"
                                 class="rounded-circle">
                        </div>
                        <div class="col-sm-2 offset-sm-1">
                            <p class="category">Raised</p>
                            <img src="{{URL::asset("userassets/img/avatar.jpg")}}" alt="Raised Image"
                                 class="rounded img-raised">
                        </div>
                        <div class="col-sm-2 offset-sm-1">
                            <p class="category">Circle Raised</p>
                            <img src="{{URL::asset("userassets/img/avatar.jpg")}}" alt="Thumbnail Image"
        ...
        <div class="section section-javascript" id="javascriptComponents">
            <div class="container">
                ...
                <div class="row" id="modals">
                    ...
                    <div class="col-md-6">
                        <h4>Popovers</h4>
                        <button type="button" class="btn btn-default" data-color="popover-primary" data-toggle="popover"
                        ...
                        <div id="carouselExampleControls" class="carousel slide">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block" src="{{URL::asset("userassets/img/bg1.jpg")}}"
                                         alt="First slide">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block" src="{{URL::asset("userassets/img/bg3.jpg")}}"
                                         alt="Second slide">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block" src="{{URL::asset("userassets/img/bg4.jpg")}}"
                                         alt="Third slide">
                                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <a href="nucleo-icons.html" class="btn btn-primary btn-round btn-lg" target="_blank">View Demo
                            Icons</a>
                        <a href="https://nucleoapp.com/?ref=creativetim"
            ...
            <div class="container text-center">
                <div class="row justify-content-md-center">
                    <div class="col-md-12 col-lg-8">
                        ...
                        <h5 class="description">The kit comes with three pre-built pages to help you get started faster.
                            You can change the text and images and you're good to go. More importantly, looking at them
                            will give you a picture of what you can built with this powerful Bootstrap 4 ui kit.</h4>
                    </div>
                </div>
            </div>
        </div>
        <div class="section section-signup"
             style="background-image: url({{URL::asset("userassets/img/bg11.jpg")}}); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                ...
                <div class="col text-center">
                    <a href="examples/login-page.html" class="btn btn-simple btn-round btn-white btn-lg"
                ...
                <div class="row">
                    <div class="col">
                        <a href="examples/landing-page.html" target="_blank">
                            <img src="{{URL::asset("userassets/img/landing.jpg")}}" alt="Image" class="img-raised">
                        </a>
                    ...
                    <div class="col">
                        <a href="examples/profile-page.html" target="_blank">
                            <img src="{{URL::asset("userassets/img/profile.jpg")}}" alt="Image" class="img-raised">
                        </a>
                ...
                <div class="row justify-content-md-center sharing-area text-center">
                    ...
                    <div class="text-center col-md-12 col-lg-8">
                        <a target="_blank" href="https://www.twitter.com/creativetim"
                           class="btn btn-neutral btn-icon btn-twitter" rel="tooltip" title="Follow us">
                            <i class="fa fa-twitter"></i>
                        </a>
                        <a target="_blank" href="https://www.facebook.com/creativetim"
                           class="btn btn-neutral btn-icon btn-facebook" rel="tooltip" title="Like us">
                            <i class="fa fa-facebook-square"></i>
                        </a>
                        <a target="_blank" href="https://www.linkedin.com/company-beta/9430489/"
                           class="btn btn-neutral btn-icon btn-linkedin" rel="tooltip" title="Follow us">
                            <i class="fa fa-linkedin"></i>
                        </a>
                        <a target="_blank" href="https://github.com/creativetimofficial/now-ui-kit"
                           class="btn btn-neutral btn-icon btn-github" rel="tooltip" title="Star on Github">
